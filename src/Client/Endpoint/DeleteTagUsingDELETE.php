...
class DeleteTagUsingDELETE extends \Jlonom\AllegroSDK\Runtime\Client\BaseEndpoint implements \Jlonom\AllegroSDK\Runtime\Client\Endpoint
{
    protected $tagId;
    protected $accept;
    /**
     ...
     */
    public function __construct(string $tagId, array $accept = [])
    {
        $this->tagId = $tagId;
        $this->accept = $accept;
    }
