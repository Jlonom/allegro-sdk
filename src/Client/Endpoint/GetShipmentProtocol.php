...
class GetShipmentProtocol extends \Jlonom\AllegroSDK\Runtime\Client\BaseEndpoint implements \Jlonom\AllegroSDK\Runtime\Client\Endpoint
{
    protected $accept;
    /**
     ...
     */
    public function __construct(\Jlonom\AllegroSDK\Model\ShipmentIdsDto $requestBody, array $accept = [])
    {
    ...
    {
        if ($this->body instanceof \Jlonom\AllegroSDK\Model\ShipmentIdsDto) {
