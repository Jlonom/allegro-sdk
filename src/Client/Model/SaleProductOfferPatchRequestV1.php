...
class SaleProductOfferPatchRequestV1 extends \ArrayObject
{
     ...
     * 
     *
     * @var list<SaleProductOfferPatchRequestV1productSetItem>
     */
     ...
     *
     * @var SaleProductOfferPatchRequestV1compatibilityList
     */
    ...
    */
     ...
     * 
     *
     * @return list<SaleProductOfferPatchRequestV1productSetItem>
     */
     ...
     * 
     *
     * @param list<SaleProductOfferPatchRequestV1productSetItem> $productSet
     *
     * @return self
     */
     ...
     * For the `/sale/product-offers` resources you can send only definition of the MANUAL compatibility list. If compatibility list is provided for the product assigned to the offer, it will be used automatically.
     *
     * @return SaleProductOfferPatchRequestV1compatibilityList
     */
     ...
     * For the `/sale/product-offers` resources you can send only definition of the MANUAL compatibility list. If compatibility list is provided for the product assigned to the offer, it will be used automatically.
     *
     * @param SaleProductOfferPatchRequestV1compatibilityList $compatibilityList
     *
     * @return self
     */
