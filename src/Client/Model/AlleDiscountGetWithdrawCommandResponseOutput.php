...
class AlleDiscountGetWithdrawCommandResponseOutput extends \ArrayObject
{
    ...
    */
     ...
     * Withdrawn offer participation data. Non-null when command status is `SUCCESSFUL`.
     *
     * @return AlleDiscountGetWithdrawCommandResponseOutputWithdrawnOfferParticipation|null
     */
     ...
     * Withdrawn offer participation data. Non-null when command status is `SUCCESSFUL`.
     *
     * @param AlleDiscountGetWithdrawCommandResponseOutputWithdrawnOfferParticipation|null $withdrawnOfferParticipation
     *
     * @return self
     */
