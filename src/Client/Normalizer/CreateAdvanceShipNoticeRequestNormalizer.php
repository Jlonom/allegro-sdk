...
class CreateAdvanceShipNoticeRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\CreateAdvanceShipNoticeRequest::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\CreateAdvanceShipNoticeRequest::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\CreateAdvanceShipNoticeRequest();
        ...
        if (\array_key_exists('shipping', $data)) {
            $object->setShipping($this->denormalizer->denormalize($data['shipping'], \Jlonom\AllegroSDK\Model\Shipping::class, 'json', $context));
            unset($data['shipping']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\CreateAdvanceShipNoticeRequest::class => false];
    }
}