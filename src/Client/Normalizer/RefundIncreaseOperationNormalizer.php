...
class RefundIncreaseOperationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\RefundIncreaseOperation::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\RefundIncreaseOperation::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\RefundIncreaseOperation();
        ...
        if (\array_key_exists('participant', $data)) {
            $object->setParticipant($this->denormalizer->denormalize($data['participant'], \Jlonom\AllegroSDK\Model\SellerParticipant::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\RefundIncreaseOperation::class => false];
    }
}