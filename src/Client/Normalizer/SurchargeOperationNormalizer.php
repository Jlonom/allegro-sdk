...
class SurchargeOperationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\SurchargeOperation::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\SurchargeOperation::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\SurchargeOperation();
        ...
        if (\array_key_exists('surcharge', $data)) {
            $object->setSurcharge($this->denormalizer->denormalize($data['surcharge'], \Jlonom\AllegroSDK\Model\Surcharge::class, 'json', $context));
            unset($data['surcharge']);
        }
        if (\array_key_exists('participant', $data)) {
            $object->setParticipant($this->denormalizer->denormalize($data['participant'], \Jlonom\AllegroSDK\Model\BuyerParticipant::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\SurchargeOperation::class => false];
    }
}