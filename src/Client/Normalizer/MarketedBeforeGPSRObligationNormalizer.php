...
class MarketedBeforeGPSRObligationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\MarketedBeforeGPSRObligation::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\MarketedBeforeGPSRObligation::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\MarketedBeforeGPSRObligation();
    ...
    {
        return [\Jlonom\AllegroSDK\Model\MarketedBeforeGPSRObligation::class => false];
    }
}