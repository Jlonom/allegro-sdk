...
class ClassifiedPackagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\ClassifiedPackages::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\ClassifiedPackages::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\ClassifiedPackages();
        ...
        if (\array_key_exists('extraPackages', $data)) {
            ...
            foreach ($data['extraPackages'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\ClassifiedPackage::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\ClassifiedPackages::class => false];
    }
}