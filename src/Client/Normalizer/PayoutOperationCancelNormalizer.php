...
class PayoutOperationCancelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\PayoutOperationCancel::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\PayoutOperationCancel::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\PayoutOperationCancel();
        ...
        if (\array_key_exists('payout', $data)) {
            $object->setPayout($this->denormalizer->denormalize($data['payout'], \Jlonom\AllegroSDK\Model\Payout::class, 'json', $context));
            unset($data['payout']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\PayoutOperationCancel::class => false];
    }
}