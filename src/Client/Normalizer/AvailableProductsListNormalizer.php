...
class AvailableProductsListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\AvailableProductsList::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\AvailableProductsList::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\AvailableProductsList();
        ...
        if (\array_key_exists('products', $data)) {
            ...
            foreach ($data['products'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\AvailableProductResponse::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\AvailableProductsList::class => false];
    }
}