...
class AdditionalServiceResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\AdditionalServiceResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\AdditionalServiceResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\AdditionalServiceResponse();
        ...
        if (\array_key_exists('definition', $data)) {
            $object->setDefinition($this->denormalizer->denormalize($data['definition'], \Jlonom\AllegroSDK\Model\BasicDefinitionResponse::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\AdditionalServiceResponse::class => false];
    }
}