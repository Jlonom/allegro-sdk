...
class VariantSetsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\VariantSets::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\VariantSets::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\VariantSets();
        ...
        if (\array_key_exists('offerVariants', $data)) {
            $values = [];
            foreach ($data['offerVariants'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\VariantSetsVariantSet::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\VariantSets::class => false];
    }
}