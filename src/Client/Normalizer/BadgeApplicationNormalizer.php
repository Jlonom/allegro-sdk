...
class BadgeApplicationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\BadgeApplication::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\BadgeApplication::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\BadgeApplication();
        ...
        if (\array_key_exists('process', $data)) {
            $object->setProcess($this->denormalizer->denormalize($data['process'], \Jlonom\AllegroSDK\Model\BadgeApplicationProcess::class, 'json', $context));
            unset($data['process']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\BadgeApplication::class => false];
    }
}