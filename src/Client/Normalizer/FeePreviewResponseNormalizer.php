...
class FeePreviewResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\FeePreviewResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\FeePreviewResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\FeePreviewResponse();
        ...
        if (\array_key_exists('commissions', $data)) {
            ...
            foreach ($data['commissions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\CommissionResponse::class, 'json', $context);
            }
        ...
        if (\array_key_exists('quotes', $data)) {
            ...
            foreach ($data['quotes'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Jlonom\AllegroSDK\Model\QuoteResponse::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\FeePreviewResponse::class => false];
    }
}