...
class WarrantyResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\WarrantyResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\WarrantyResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\WarrantyResponse();
        ...
        if (\array_key_exists('attachment', $data)) {
            $object->setAttachment($this->denormalizer->denormalize($data['attachment'], \Jlonom\AllegroSDK\Model\AfterSalesServicesAttachment::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\WarrantyResponse::class => false];
    }
}