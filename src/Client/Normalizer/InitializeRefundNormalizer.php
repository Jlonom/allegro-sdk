...
class InitializeRefundNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\InitializeRefund::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\InitializeRefund::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\InitializeRefund();
        ...
        if (\array_key_exists('delivery', $data)) {
            $object->setDelivery($this->denormalizer->denormalize($data['delivery'], \Jlonom\AllegroSDK\Model\InitializeRefundDelivery::class, 'json', $context));
            unset($data['delivery']);
        }
        if (\array_key_exists('overpaid', $data)) {
            $object->setOverpaid($this->denormalizer->denormalize($data['overpaid'], \Jlonom\AllegroSDK\Model\InitializeRefundOverpaid::class, 'json', $context));
            unset($data['overpaid']);
        }
        ...
        if (\array_key_exists('additionalServices', $data)) {
            $object->setAdditionalServices($this->denormalizer->denormalize($data['additionalServices'], \Jlonom\AllegroSDK\Model\InitializeRefundAdditionalServices::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\InitializeRefund::class => false];
    }
}