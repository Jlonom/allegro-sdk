...
class CheckoutFormsOrderInvoiceFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\CheckoutFormsOrderInvoiceFile::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\CheckoutFormsOrderInvoiceFile::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\CheckoutFormsOrderInvoiceFile();
        ...
        if (\array_key_exists('securityVerification', $data)) {
            $object->setSecurityVerification($this->denormalizer->denormalize($data['securityVerification'], \Jlonom\AllegroSDK\Model\CheckoutFormsOrderInvoiceFileSecurityVerification::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\CheckoutFormsOrderInvoiceFile::class => false];
    }
}