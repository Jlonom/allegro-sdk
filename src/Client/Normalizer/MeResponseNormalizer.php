...
class MeResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\MeResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\MeResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\MeResponse();
        ...
        if (\array_key_exists('baseMarketplace', $data)) {
            $object->setBaseMarketplace($this->denormalizer->denormalize($data['baseMarketplace'], \Jlonom\AllegroSDK\Model\MeResponseBaseMarketplace::class, 'json', $context));
            unset($data['baseMarketplace']);
        }
        if (\array_key_exists('company', $data)) {
            $object->setCompany($this->denormalizer->denormalize($data['company'], \Jlonom\AllegroSDK\Model\Company::class, 'json', $context));
            unset($data['company']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\MeResponse::class => false];
    }
}