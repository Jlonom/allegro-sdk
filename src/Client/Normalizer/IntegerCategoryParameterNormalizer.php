...
class IntegerCategoryParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\IntegerCategoryParameter::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\IntegerCategoryParameter::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\IntegerCategoryParameter();
        ...
        if (\array_key_exists('restrictions', $data)) {
            $object->setRestrictions($this->denormalizer->denormalize($data['restrictions'], \Jlonom\AllegroSDK\Model\IntegerCategoryParameterrestrictions::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\IntegerCategoryParameter::class => false];
    }
}