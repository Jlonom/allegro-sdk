...
class SellingModeWithNetPriceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\SellingModeWithNetPrice::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\SellingModeWithNetPrice::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\SellingModeWithNetPrice();
        ...
        if (\array_key_exists('netPrice', $data)) {
            $object->setNetPrice($this->denormalizer->denormalize($data['netPrice'], \Jlonom\AllegroSDK\Model\NetPrice::class, 'json', $context));
            unset($data['netPrice']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\SellingModeWithNetPrice::class => false];
    }
}