...
class SaleProductOfferPatchRequestV1productSetItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1productSetItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1productSetItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1productSetItem();
        ...
        if (\array_key_exists('responsiblePerson', $data)) {
            $object->setResponsiblePerson($this->denormalizer->denormalize($data['responsiblePerson'], \Jlonom\AllegroSDK\Model\ProductSetElementResponsiblePersonRequestResponsiblePerson::class, 'json', $context));
            unset($data['responsiblePerson']);
        }
        if (\array_key_exists('responsibleProducer', $data)) {
            $object->setResponsibleProducer($this->denormalizer->denormalize($data['responsibleProducer'], \Jlonom\AllegroSDK\Model\ProductSetElementResponsibleProducerRequest::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1productSetItem::class => false];
    }
}