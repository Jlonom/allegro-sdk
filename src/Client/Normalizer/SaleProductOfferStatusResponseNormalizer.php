...
class SaleProductOfferStatusResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\SaleProductOfferStatusResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\SaleProductOfferStatusResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\SaleProductOfferStatusResponse();
        ...
        if (\array_key_exists('operation', $data)) {
            $object->setOperation($this->denormalizer->denormalize($data['operation'], \Jlonom\AllegroSDK\Model\SaleProductOfferStatusResponseOperation::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\SaleProductOfferStatusResponse::class => false];
    }
}