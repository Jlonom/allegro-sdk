...
class DictionaryCategoryProductParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\DictionaryCategoryProductParameter::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\DictionaryCategoryProductParameter::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\DictionaryCategoryProductParameter();
        ...
        if (\array_key_exists('restrictions', $data)) {
            $object->setRestrictions($this->denormalizer->denormalize($data['restrictions'], \Jlonom\AllegroSDK\Model\DictionaryCategoryProductParameterrestrictions::class, 'json', $context));
            unset($data['restrictions']);
        }
        if (\array_key_exists('dictionary', $data)) {
            $values = [];
            foreach ($data['dictionary'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\DictionaryCategoryProductParameterdictionaryItem::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\DictionaryCategoryProductParameter::class => false];
    }
}