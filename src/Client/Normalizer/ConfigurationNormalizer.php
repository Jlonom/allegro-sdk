...
class ConfigurationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\Configuration::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\Configuration::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\Configuration();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('constraintCriteria', $data)) {
            $object->setConstraintCriteria($this->denormalizer->denormalize($data['constraintCriteria'], \Jlonom\AllegroSDK\Model\ConstraintCriteria::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\Configuration::class => false];
    }
}