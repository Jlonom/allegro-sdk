...
class PaymentsRefundsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\PaymentsRefundsGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\PaymentsRefundsGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\PaymentsRefundsGetResponse200();
        ...
        if (\array_key_exists('refunds', $data)) {
            ...
            foreach ($data['refunds'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\RefundDetails::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\PaymentsRefundsGetResponse200::class => false];
    }
}