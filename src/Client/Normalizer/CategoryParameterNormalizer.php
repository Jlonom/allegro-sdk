...
class CategoryParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\CategoryParameter::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\CategoryParameter::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        if (array_key_exists('type', $data) and 'integer' === $data['type']) {
            return $this->denormalizer->denormalize($data, 'Jlonom\AllegroSDK\Model\IntegerCategoryParameter', $format, $context);
        }
        if (array_key_exists('type', $data) and 'float' === $data['type']) {
            return $this->denormalizer->denormalize($data, 'Jlonom\AllegroSDK\Model\FloatCategoryParameter', $format, $context);
        }
        if (array_key_exists('type', $data) and 'string' === $data['type']) {
            return $this->denormalizer->denormalize($data, 'Jlonom\AllegroSDK\Model\StringCategoryParameter', $format, $context);
        }
        if (array_key_exists('type', $data) and 'dictionary' === $data['type']) {
            return $this->denormalizer->denormalize($data, 'Jlonom\AllegroSDK\Model\DictionaryCategoryParameter', $format, $context);
        }
        if (isset($data['$ref'])) {
        ...
        $object = new \Jlonom\AllegroSDK\Model\CategoryParameter();
    ...
    {
        return [\Jlonom\AllegroSDK\Model\CategoryParameter::class => false];
    }
}