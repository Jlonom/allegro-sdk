...
class DeductionIncreaseOperationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\DeductionIncreaseOperation::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\DeductionIncreaseOperation::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\DeductionIncreaseOperation();
        ...
        if (\array_key_exists('deduction', $data)) {
            $object->setDeduction($this->denormalizer->denormalize($data['deduction'], \Jlonom\AllegroSDK\Model\Deduction::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\DeductionIncreaseOperation::class => false];
    }
}