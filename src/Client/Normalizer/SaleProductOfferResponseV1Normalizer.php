...
class SaleProductOfferResponseV1Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\SaleProductOfferResponseV1::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\SaleProductOfferResponseV1::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\SaleProductOfferResponseV1();
        ...
        if (\array_key_exists('productSet', $data)) {
            ...
            foreach ($data['productSet'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\SaleProductOfferResponseV1productSetItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('attachments', $data)) {
            ...
            foreach ($data['attachments'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Jlonom\AllegroSDK\Model\ProductOfferAttachmentItem::class, 'json', $context);
            }
            $object->setAttachments($values_2);
            unset($data['attachments']);
        }
        if (\array_key_exists('fundraisingCampaign', $data)) {
            $object->setFundraisingCampaign($this->denormalizer->denormalize($data['fundraisingCampaign'], \Jlonom\AllegroSDK\Model\ProductOfferFundraisingCampaignResponse::class, 'json', $context));
            unset($data['fundraisingCampaign']);
        }
        if (\array_key_exists('additionalServices', $data)) {
            $object->setAdditionalServices($this->denormalizer->denormalize($data['additionalServices'], \Jlonom\AllegroSDK\Model\ProductOfferAdditionalServicesResponse::class, 'json', $context));
            unset($data['additionalServices']);
        }
        if (\array_key_exists('delivery', $data)) {
            $object->setDelivery($this->denormalizer->denormalize($data['delivery'], \Jlonom\AllegroSDK\Model\DeliveryProductOfferResponse::class, 'json', $context));
            unset($data['delivery']);
        }
        if (\array_key_exists('publication', $data)) {
            $object->setPublication($this->denormalizer->denormalize($data['publication'], \Jlonom\AllegroSDK\Model\SaleProductOfferPublicationResponse::class, 'json', $context));
        ...
        if (\array_key_exists('additionalMarketplaces', $data)) {
            ...
            foreach ($data['additionalMarketplaces'] as $key_1 => $value_3) {
                $values_3[$key_1] = $this->denormalizer->denormalize($value_3, \Jlonom\AllegroSDK\Model\AdditionalMarketplacesResponseItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('compatibilityList', $data)) {
            $object->setCompatibilityList($this->denormalizer->denormalize($data['compatibilityList'], \Jlonom\AllegroSDK\Model\CompatibilityListProductOfferResponse::class, 'json', $context));
        ...
        if (\array_key_exists('validation', $data)) {
            $object->setValidation($this->denormalizer->denormalize($data['validation'], \Jlonom\AllegroSDK\Model\Validation::class, 'json', $context));
            unset($data['validation']);
        }
        if (\array_key_exists('warnings', $data)) {
            $values_4 = [];
            foreach ($data['warnings'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, \Jlonom\AllegroSDK\Model\Error::class, 'json', $context);
            }
        ...
        if (\array_key_exists('discounts', $data)) {
            $object->setDiscounts($this->denormalizer->denormalize($data['discounts'], \Jlonom\AllegroSDK\Model\DiscountsProductOfferResponse::class, 'json', $context));
            unset($data['discounts']);
        }
        if (\array_key_exists('stock', $data)) {
            $object->setStock($this->denormalizer->denormalize($data['stock'], \Jlonom\AllegroSDK\Model\Stock::class, 'json', $context));
            unset($data['stock']);
        }
        if (\array_key_exists('parameters', $data)) {
            $values_5 = [];
            foreach ($data['parameters'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, \Jlonom\AllegroSDK\Model\ParameterProductOfferResponse::class, 'json', $context);
            }
            $object->setParameters($values_5);
            unset($data['parameters']);
        }
        if (\array_key_exists('contact', $data)) {
            $object->setContact($this->denormalizer->denormalize($data['contact'], \Jlonom\AllegroSDK\Model\SaleProductOfferResponseV1contact::class, 'json', $context));
            unset($data['contact']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\SaleProductOfferResponseV1::class => false];
    }
}