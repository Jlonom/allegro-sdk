...
class PublicOfferPreviewRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\PublicOfferPreviewRequest::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\PublicOfferPreviewRequest::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\PublicOfferPreviewRequest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('offer', $data)) {
            $object->setOffer($this->denormalizer->denormalize($data['offer'], \Jlonom\AllegroSDK\Model\PricingOffer::class, 'json', $context));
            unset($data['offer']);
        }
        if (\array_key_exists('classifiedsPackages', $data)) {
            $object->setClassifiedsPackages($this->denormalizer->denormalize($data['classifiedsPackages'], \Jlonom\AllegroSDK\Model\ClassifiedsPackages::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\PublicOfferPreviewRequest::class => false];
    }
}