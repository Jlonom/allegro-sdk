...
class ShippingExtendedNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\ShippingExtended::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\ShippingExtended::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (array_key_exists('method', $data) and 'ALREADY_IN_WAREHOUSE' === $data['method']) {
            return $this->denormalizer->denormalize($data, 'Jlonom\AllegroSDK\Model\AlreadyInWarehouseShipping', $format, $context);
        }
        if (isset($data['$ref'])) {
        ...
        $object = new \Jlonom\AllegroSDK\Model\ShippingExtended();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (null !== $data->getMethod() and 'ALREADY_IN_WAREHOUSE' === $data->getMethod()) {
            return $this->normalizer->normalize($data, $format, $context);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\ShippingExtended::class => false];
    }
}