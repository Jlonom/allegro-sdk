...
class PickupDateProposalsDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\PickupDateProposalsDto::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\PickupDateProposalsDto::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\PickupDateProposalsDto();
        ...
        if (\array_key_exists('proposalItems', $data)) {
            $values = [];
            foreach ($data['proposalItems'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\PickupDateProposalDto::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\PickupDateProposalsDto::class => false];
    }
}