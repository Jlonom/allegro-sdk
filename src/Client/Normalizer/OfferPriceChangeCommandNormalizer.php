...
class OfferPriceChangeCommandNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\OfferPriceChangeCommand::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\OfferPriceChangeCommand::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\OfferPriceChangeCommand();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('modification', $data)) {
            $object->setModification($this->denormalizer->denormalize($data['modification'], \Jlonom\AllegroSDK\Model\PriceModification::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\OfferPriceChangeCommand::class => false];
    }
}