...
class DeliveryProductOfferResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\DeliveryProductOfferResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\DeliveryProductOfferResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\DeliveryProductOfferResponse();
        ...
        if (\array_key_exists('shippingRates', $data)) {
            $object->setShippingRates($this->denormalizer->denormalize($data['shippingRates'], \Jlonom\AllegroSDK\Model\JustId::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\DeliveryProductOfferResponse::class => false];
    }
}