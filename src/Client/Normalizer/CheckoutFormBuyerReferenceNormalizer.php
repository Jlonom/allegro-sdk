...
class CheckoutFormBuyerReferenceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\CheckoutFormBuyerReference::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\CheckoutFormBuyerReference::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\CheckoutFormBuyerReference();
        ...
        if (\array_key_exists('personalIdentity', $data)) {
        ...
        if (\array_key_exists('preferences', $data)) {
            $object->setPreferences($this->denormalizer->denormalize($data['preferences'], \Jlonom\AllegroSDK\Model\BuyerPreferencesReference::class, 'json', $context));
            unset($data['preferences']);
        }
        if (\array_key_exists('address', $data)) {
            $object->setAddress($this->denormalizer->denormalize($data['address'], \Jlonom\AllegroSDK\Model\CheckoutFormBuyerAddressReference::class, 'json', $context));
            unset($data['address']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\CheckoutFormBuyerReference::class => false];
    }
}