...
class DisputeFirstMessageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\DisputeFirstMessage::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\DisputeFirstMessage::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\DisputeFirstMessage();
        ...
        if (\array_key_exists('author', $data)) {
            $object->setAuthor($this->denormalizer->denormalize($data['author'], \Jlonom\AllegroSDK\Model\DisputeAuthor::class, 'json', $context));
            unset($data['author']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\DisputeFirstMessage::class => false];
    }
}