...
class FulfillmentOrderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\FulfillmentOrder::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\FulfillmentOrder::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\FulfillmentOrder();
        ...
        if (\array_key_exists('parcels', $data)) {
            ...
            foreach ($data['parcels'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\FulfillmentOrderParcel::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\FulfillmentOrder::class => false];
    }
}