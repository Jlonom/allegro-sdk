...
class SaleProductOfferPatchRequestV1Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1();
        ...
        if (\array_key_exists('productSet', $data)) {
            ...
            foreach ($data['productSet'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1productSetItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('compatibilityList', $data)) {
            $object->setCompatibilityList($this->denormalizer->denormalize($data['compatibilityList'], \Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1compatibilityList::class, 'json', $context));
    ...
    {
        return [\Jlonom\AllegroSDK\Model\SaleProductOfferPatchRequestV1::class => false];
    }
}