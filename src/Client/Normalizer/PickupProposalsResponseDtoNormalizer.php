...
class PickupProposalsResponseDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\PickupProposalsResponseDto::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\PickupProposalsResponseDto::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\PickupProposalsResponseDto();
        ...
        if (\array_key_exists('proposals', $data)) {
            ...
            foreach ($data['proposals'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jlonom\AllegroSDK\Model\PickupDateProposalsDto::class, 'json', $context);
            }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\PickupProposalsResponseDto::class => false];
    }
}