...
class OfferRulesRulesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jlonom\AllegroSDK\Model\OfferRulesRulesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jlonom\AllegroSDK\Model\OfferRulesRulesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jlonom\AllegroSDK\Model\OfferRulesRulesItem();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('marketplace', $data)) {
            $object->setMarketplace($this->denormalizer->denormalize($data['marketplace'], \Jlonom\AllegroSDK\Model\OfferRulesRulesItemMarketplace::class, 'json', $context));
            unset($data['marketplace']);
        }
        if (\array_key_exists('rule', $data)) {
            $object->setRule($this->denormalizer->denormalize($data['rule'], \Jlonom\AllegroSDK\Model\OfferRulesRulesItemRule::class, 'json', $context));
            unset($data['rule']);
        }
    ...
    {
        return [\Jlonom\AllegroSDK\Model\OfferRulesRulesItem::class => false];
    }
}